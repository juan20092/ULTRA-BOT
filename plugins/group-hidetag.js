...
let thumb = null
fetch('https://files.catbox.moe/1ruf7n.jpg')
  ...
  try {
    ...
    if (isMedia) {
      ...
      if (mtype === 'audioMessage') {
        ...
        if (userText) {
          await conn.sendMessage(m.chat, { text: `${userText}\n\n${watermark}`, mentions: users }, { quoted: fkontak });
        } else {
          await conn.sendMessage(m.chat, { text: watermark, mentions: users }, { quoted: fkontak });
        }
        return;
      }
