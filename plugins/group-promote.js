const handler = async (m, { conn, participants, usedPrefix, command, rcanal }) => {
  ...
  await conn.sendMessage(m.chat, {
    text: `> 🔝 *𝘜𝘴𝘦𝘳 𝘱𝘳𝘰𝘮𝘰𝘷𝘪𝘥𝘰 𝘦𝘹𝘪𝘵𝘰𝘴𝘢𝘮𝘦𝘯𝘵𝘦*\n> @${user. split('@')[0]} 𝘈𝘩𝘰𝘳𝘢 𝘦𝘴 𝘢𝘥𝘮𝘪𝘯`,
    mentions: [user]
  }, { quoted: m })
}
